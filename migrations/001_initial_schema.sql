...
CREATE TABLE IF NOT EXISTS `commitments` (
  ...
  `contact_id` BIGINT UNSIGNED DEFAULT NULL COMMENT 'Contato credor ou devedor',
  `responsible_user_id` BIGINT UNSIGNED NOT NULL COMMENT 'Usuário responsável por quitar/cobrar',
  `estimated_account_id` BIGINT UNSIGNED DEFAULT NULL COMMENT 'Conta prevista para liquidação',
